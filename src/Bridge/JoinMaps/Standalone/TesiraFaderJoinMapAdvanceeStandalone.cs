...
namespace Pepperdash.Essentials.Plugins.DSP.Biamp.Tesira.Bridge.JoinMaps.Standalone
{
    ...
    /// </summary>
    public class TesiraFaderJoinMapAdvancedStandalone : JoinMapBaseAdvanced
    {
        [JoinName("VolumeUp")]
        ...
        [JoinName("MuteOn")]
        public JoinDataComplete MuteOn =
        ...
        [JoinName("MuteOff")]
        public JoinDataComplete MuteOff =
        ...
        [JoinName("MuteToggle")]
        public JoinDataComplete MuteToggle =
        ...
        [JoinName("Visible")]
        public JoinDataComplete Visible =
        ...
        [JoinName("Volume")]
        public JoinDataComplete Volume =
            new JoinDataComplete(new JoinData { JoinNumber = 1, JoinSpan = 1 },
                new JoinMetadata
                {
        ...
        public JoinDataComplete Permissions =
            new JoinDataComplete(new JoinData { JoinNumber = 4, JoinSpan = 1 },
                new JoinMetadata
                {
        ...
        public TesiraFaderJoinMapAdvancedStandalone(uint joinStart)
            : base(joinStart, typeof(TesiraFaderJoinMapAdvancedStandalone))
        {
        }
