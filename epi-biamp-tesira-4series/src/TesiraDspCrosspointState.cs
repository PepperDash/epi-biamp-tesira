...
namespace Tesira_DSP_EPI
{
    ...
    public class TesiraDspCrosspointState : TesiraDspControlPoint
    {
        ...
        public override void ParseGetMessage(string attributeCode, string message)
        {
            try
            {
                Debug.LogVerbose(this, "Parsing Message - '{0}' : Message has an attributeCode of {1}", message,
                    attributeCode);
                // Parse an "+OK" message
                ...
                Debug.LogDebug(this, "xPoint Response: '{0}' Value: '{1}'", attributeCode, value);

				if (message.Contains("StandardMixerInterface"))
				{

					AttributeCode = string.Format("crosspoint {0} {1}", Index1, Index2);
					Debug.LogVerbose(this, "StandardMixerInterface: {0}", AttributeCode);
					GetState();
					return;
				}
                ...
                Debug.LogVerbose(this, "New Value: {0}", _state);
        ...
        public override void LinkToApi(BasicTriList trilist, uint joinStart, string joinMapKey, EiscApiAdvanced bridge)
        {
            ...
            Debug.LogVerbose(this, "Adding Crosspoint State ControlPoint {0} | JoinStart:{1}", Key, joinMap.Label.JoinNumber);
