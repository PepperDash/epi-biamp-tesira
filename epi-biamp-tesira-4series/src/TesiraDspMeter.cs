...
namespace Tesira_DSP_EPI
{
    ...
    public class TesiraDspMeter : TesiraDspControlPoint
    {
        ...
        public override void ParseSubscriptionMessage(string customName, string message)
        {
            ...
            Debug.LogVerbose(this, "Parsing Message - '{0}'", message);
            ...
            Debug.LogVerbose(this, "Scaled Meter Value - '{0}'", _currentMeter);
        ...
        public override void LinkToApi(BasicTriList trilist, uint joinStart, string joinMapKey, EiscApiAdvanced bridge)
        {
            ...
            Debug.LogVerbose(this, "AddingMeterBridge {0} | Join:{1}", Key, joinMap.Label.JoinNumber);
