    ...
    public class TesiraDspDialer : TesiraDspDialerControlPoint, IBridgeAdvanced
    {
        ...
        public bool OffHookStatus
        {
            ...
            protected set {
                ...
                Debug.LogVerbose(this, "_OffHookStatus = {0}", value.ToString());
		...
		private void Initialize(TesiraDialerControlBlockConfig config)
		{
            ...
            Debug.LogVerbose(this, "Adding Dialer '{0}'", Key);
        ...
        public override void ParseSubscriptionMessage(string customName, string value)
        {
            try
            {
                ...
                if (customName == ControlStatusCustomName || customName == PotsDialerCustomName)
                {
                    ...
                    if (match2.Success)
                    {
                        ...
                        Debug.LogVerbose(this, "Callstate for Line {0} is {1}", lineNumber, int.Parse(match2.Groups["state"].Value));
                        Debug.LogVerbose(this, "Callstate Enum for Line {0} is {1}", lineNumber, (int)CallStatusEnum);
                        ...
                        if (match3.Success)
                        {
                            ...
                            {
                                Debug.LogVerbose(this, "CallState Complete - Firing Updates");
                                CallerIdNumberFeedback.FireUpdate();
                                OffHookFeedback.FireUpdate();
                                if (IsVoip)
            ...
            {
                Debug.LogMessage(0, this, "Error in ParseSubscriptioMessage - {0}", e.Message);
            }
            ...
            try {
                ...
                switch (attributeCode) {
                    case "autoAnswer": {
                        ...
                        Debug.LogDebug(this, "AutoAnswerState is '{0}'", AutoAnswerState);
                    ...
                    case "dndEnable": {
                        ...
                        Debug.LogDebug(this, "DoNotDisturbState is '{0}'", DoNotDisturbState);
                    ...
                    default: {
                        Debug.LogVerbose("Response does not match expected attribute codes: '{0}'", message);
...
// ReSharper restore InconsistentNaming
        ...
        void IBridgeAdvanced.LinkToApi(BasicTriList trilist, uint joinStart, string joinMapKey, EiscApiAdvanced bridge)
        {
            ...
            Debug.LogVerbose("Adding Dialer {0}", Key);
