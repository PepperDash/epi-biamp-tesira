...
namespace Tesira_DSP_EPI
{
    public class TesiraDspRoomCombiner : TesiraDspControlPoint, IBasicVolumeWithFeedback, IVolumeComponent
    {
		...
		private void Initialize(TesiraRoomCombinerBlockConfig config)
        {
            ...
            Debug.LogVerbose(this, "Adding RoomCombiner '{0}'", Key);
            ...
            try
            {
                ...
                switch (attributeCode)
                {
                    ...
                    case "muteOut" :
                    {
                        ...
                        Debug.LogDebug(this, "MuteState is '{0}'", value);
                        _pollTimer.Reset(30000);
                        break;
                    }
                    ...
                    case "group":
                    {
                        ...
                        Debug.LogDebug(this, "Room Group is '{0}'", value);
                        _pollTimer.Reset(30000);
                        break;
                    }
                    default:
        ...
        {
            Debug.LogDebug(this, "group: {0}", group);
        ...
        public override void LinkToApi(BasicTriList trilist, uint joinStart, string joinMapKey, EiscApiAdvanced bridge)
        {
            ...
            Debug.LogVerbose("Tesira Room Combiner {0} connect", Key);
