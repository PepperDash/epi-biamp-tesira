...
namespace Tesira_DSP_EPI
{
    public class TesiraDspSourceSelector : TesiraDspControlPoint, IRoutingWithFeedback
    {
        ...
        private void Initialize(TesiraSourceSelectorControlBlockConfig config)
        {
            ...
            Debug.LogVerbose(this, "Adding SourceSelector '{0}'", Key);
        ...
        public override void ParseGetMessage(string attributeCode, string message)
        {
            try
            {
                ...
                {
                    Debug.LogVerbose(this, "Baimp Error Address not found: '{0}'\n", InstanceTag1);
                    return;
                }
            ...
            {
                Debug.LogVerbose(this, "Unable to parse message: '{0}'\n{1}", message, e);
            }
        ...
        public void GetSourceNames()
        {
            ...
            foreach (var port in InputPorts)
            {
                ...
                Debug.LogVerbose(this, "{0} {1}", input.Key, new String('-', 50));
                ...
                Debug.LogVerbose(this, "{0}", new String('-', 50));
        ...
        {
            // Debug.LogVerbose(this, "SourceSelector DoPoll() {0}",Label);
        ...
        public override void LinkToApi(BasicTriList trilist, uint joinStart, string joinMapKey, EiscApiAdvanced bridge)
        {
            ...
            Debug.LogVerbose(this, "Tesira Switcher {0} is Enabled", Key);
