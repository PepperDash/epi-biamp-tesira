...
namespace Tesira_DSP_EPI {
    public class TesiraDspStateControl : TesiraDspControlPoint, IPrivacy {
        ...
        {
            Debug.LogVerbose(this, "New State Instance Tag = {0}", config.StateInstanceTag);
            Debug.LogVerbose(this, "Starting State {0} Initialize", key);
		...
		{
            Debug.LogVerbose(this, "Adding StateControl '{0}'", Key);
            IsSubscribed = false;
        ...
        public override void Subscribe() {
            Debug.LogVerbose(this, "StateCustomName = {0}", StateCustomName);
        ...
        public void GetState() {
            Debug.LogVerbose(this, "GetState sent to {0}", Key);
        ...
        /// </summary>
        public void StateOn() {
            Debug.LogVerbose(this, "StateOn sent to {0}", Key);
        ...
        public void StateOff() {
            Debug.LogVerbose(this, "StateOff sent to {0}", Key);
        ...
        public void StateToggle() {
            Debug.LogVerbose(this, "StateToggle sent to {0}", Key);
            if (_state) {
                SendFullCommand("set", "state", "false", 1);
            }
            else if (!_state) {
        ...
        public override void LinkToApi(BasicTriList trilist, uint joinStart, string joinMapKey, EiscApiAdvanced bridge)
        {
            ...
            Debug.LogVerbose(this, "Tesira State {0} is Enabled", Key);
